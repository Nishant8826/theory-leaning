...
- connection won't get closed after any response sends to client, can close mannually by triggering an event 'close'.
- first request will be made to upgrade the protocol from https to websocket (or from https 1.0 to https 2.0), if server accepts it then connection will get established between client and server. 
...
---
Previous: [07._Streams.md](07._Streams.md) Next: [09._Real_Time_Systems.md](09._Real_Time_Systems.md)
---
