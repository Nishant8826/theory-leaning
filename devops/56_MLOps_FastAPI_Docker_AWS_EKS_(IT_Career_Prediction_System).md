# 56 – MLOps: FastAPI + Docker + AWS EKS (IT Career Prediction System)
...
← Previous: [`55_DevSecOps_Jenkins_+_Trivy_ SonarQube_on_AWS.md`](55_DevSecOps_Jenkins_+_Trivy_ SonarQube_on_AWS.md) | Next: [`57_Advanced_Kubernetes_Concepts_and_Best_Practices.md`](57_Advanced_Kubernetes_Concepts_and_Best_Practices.md) →