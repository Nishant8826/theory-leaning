...
← Previous: [`37_Kubernetes_Introduction_Architecture_Clusters_Namespaces_and_kubectl.md`](37_Kubernetes_Introduction_Architecture_Clusters_Namespaces_and_kubectl.md) | Next: [`39_Kubernetes_Microservices_Deployment_Monolithic_vs_Microservices_GKE_and_Real_World_E_Commerce_App.md`](39_Kubernetes_Microservices_Deployment_Monolithic_vs_Microservices_GKE_and_Real_World_E_Commerce_App.md) →
