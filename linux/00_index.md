...
*   [06_user_management.md](06_user_management.md) - Creating users, setting passwords, and granting root powers.
*   [07_file_permissions.md](07_file_permissions.md) - Understanding octal permissions and securing file operations.
*   [16_linux_boot_process.md](16_linux_boot_process.md) - The step-by-step journey from power button to login prompt.
...
*   [17_logs_debugging.md](17_logs_debugging.md) - Tailing `/var/log` events and finding bugs in real-time.
*   [19_linux_day_to_day_tasks.md](19_linux_day_to_day_tasks.md) - Common tasks you'll perform daily as a developer or sysadmin.
...
*   [10_service_management.md](10_service_management.md) - Controlling background workers, PM2 equivalent concepts, and `systemctl`.
*   [18_http_status_codes.md](18_http_status_codes.md) - Knowing HTTP response mechanisms and tracking server errors analytically.
...
*   [09_system_monitoring.md](09_system_monitoring.md) - Checking server health and diagnosing disk space issues.
*   [13_ssh_key_management.md](13_ssh_key_management.md) - Logging securely into EC2 without using passwords.

### 7. Networking & Security
*Ports, firewalls (`ufw`, `iptables`), SSH config, Permissions & secrets handling*

*   [12_networking.md](12_networking.md) - Making computers talk efficiently, pinging hosts, and diagnosing port problems.

### 8. Automation & Scripting
*Bash scripting basics, Cron jobs, Automating deployments*

*   [14_vi_editor.md](14_vi_editor.md) - Handling text file edits strictly from inside the terminal.
*   [15_shell_scripting_basics.md](15_shell_scripting_basics.md) - Creating `.sh` magic to automate deploying builds flawlessly.

### 9. AI / API Workflows
*Calling APIs via curl, Handling JSON in CLI (`jq`), Testing LLM endpoints*

*   [05_advanced_commands.md](05_advanced_commands.md) - Finding items and structuring data output queries correctly.
