...
## 🧠 Resource Behavior
*   **CPU:** Increases by 5-10% during active profiling.
*   **Disk:** Profilers write logs to disk, which can grow to gigabytes for long sessions.
...
*   **A:** It's a visualization of profiled software where the X-axis is the population (time spent) and the Y-axis is the stack depth.

---

## 🧩 Practice Problems
1.  Run the Node.js built-in profiler on a simple Express app and read the processed text output.
2.  Use `clinic bubbleprof` to see how asynchronous operations (promises, timers) delay your application.
